...
.method public saveProfile(Landroid/net/sip/SipProfile;)V
    ...
    iget-object v4, p0, Lcom/android/phone/sip/SipProfileDb;->mSipSharedPreferences:Lcom/android/phone/sip/SipSharedPreferences;

    iget v5, p0, Lcom/android/phone/sip/SipProfileDb;->mProfilesCount:I

    add-int/lit8 v5, v5, 0x1

    iput v5, p0, Lcom/android/phone/sip/SipProfileDb;->mProfilesCount:I

    invoke-virtual {v4, v5}, Lcom/android/phone/sip/SipSharedPreferences;->setProfilesCount(I)V
    ...
    :goto_0
    :try_start_5
    invoke-virtual {v2, v4}, Lcom/android/internal/os/AtomicFile;->failWrite(Ljava/io/FileOutputStream;)V
